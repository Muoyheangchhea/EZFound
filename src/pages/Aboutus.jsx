        ...
        <main className="max-w-screen-xl min-w-80 mx-auto p-5 border-t border-gray-200">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 p-10 lg:px-0">
            <div className="grid place-content-center">
              <p className="font-pacifico text-xl md:text-5xl mb-5 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-orange-500 to-pink-500">
                Our Mission
              </p>
            ...
            <div className="grid place-content-center">
              <p className="font-pacifico text-xl md:text-5xl mb-5 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-blue-400 to-white">
                Our Goal
              </p>
              <span className="font-poppins">
                ...
                <div className="flex flex-col self-stretch my-auto min-w-[240px] w-[489px] max-md:max-w-full">
                  <div className="flex flex-col max-md:max-w-full">
                    ...
                    <p className="mt-5 text-xl leading-7 max-md:max-w-full text-gray-500">
                      ...
                      trusted providers. Easily browse and compare options to
                      find the perfect fit. Verified reviews ensure quality and
                      reliability. <strong>Service Listing</strong>—where
                      finding the right service is simple and fast!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 min-[500px]:grid-cols-2 md:grid-cols-6 lg:grid-cols-2 gap-8 max-w-xl mx-auto md:max-w-3xl lg:max-w-full">
                <div className="block group md:col-span-2 lg:col-span-1 justify-center just">
                  ...
                  <h4 className="font-poppins text-xl font-semibold mb-2 capitalize text-center transition-all duration-500 group-hover:text-indigo-600">
                    Ing Muyleang
                  </h4>
              ...
              <div className="flex flex-col justify-center p-2.5 w-full max-md:max-w-full">
                <div className="flex flex-col w-full max-md:max-w-full mt-[100px]">
                  <h2 className="text-4xl leading-none text-center   max-md:max-w-full">
                    <span className=" font-pacifico">Contact Us</span>
                  </h2>
