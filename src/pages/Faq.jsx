                ...
                <>
                  <div className="py-5">
                    <details className="group">
                      <summary className="flex cursor-pointer list-none items-center text-black justify-between font-medium">
                        <span>
                          How do I find the best businesses in my area?
                        </span>
                  ...
                  <div className="py-5 font-poppins">
                    <details className="group">
                      ...
                      <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                        If a business is not listed, you can submit it by going
                        to the "Add a Business" section and filling out the
                        required information, such as business name, location,
                        and service category. Our team will review and approve
                        the listing within 24-48 hours.
                      </p>
                    </details>
                  </div>
                  <div className="py-5 font-poppins">
                  ...
                  <div className="py-5 font-poppins">
                    <details className="group">
                      ...
                      <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                        Yes! You can save businesses by clicking the "Save"
                        button on their listing. Saved businesses will be stored
                ...
                <>
                  ...
                  <div className="py-5 font-poppins">
                    <details className="group">
                      ...
                      <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                        Billing for premium features like ads or enhanced
                        profiles is handled on a monthly subscription basis. You
                        will be charged automatically at the beginning of each
                        billing cycle, and you can manage your subscription
                        through your business dashboard.
                      </p>
                    </details>
                  </div>
                ...
                <>
                  <div className="py-5 font-poppins text-black">
                    <details className="group ">
                      ...
                      <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                        After visiting a business, go to their listing page,
                        click on the "Write a Review" button, and share your
                        experience. You can rate the business, leave comments,
                  ...
                  <div className="py-5  text-black font-poppins">
                    <details className="group">
                      ...
                      <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                        ...
                        below the review. Our moderation team will investigate
                  ...
                  <div className="py-5 text-black font-poppins">
                    <details className="group">
                      ...
                      <p className="group-open:animate-fadeIn mt-3 text-neutral-600">
                        ...
                        personal details, and manage your notification
                        preferences by visiting the "Account Settings" section
                        of your profile.
                      </p>
                    </details>
                  </div>
